...
public class CPopulationManager : MonoBehaviour {
    ...
    void BreedNewPopulation() {
        List<GameObject> sortedList = population.OrderBy(o => o.GetComponent<CBrain>().distanceRecord).ToList();
